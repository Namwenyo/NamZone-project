    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=15, unique=True, validators=[django.core.validators.RegexValidator(message="Phone number must be in format: '+264812345678' (12 digits total)", regex='^\\+264\\d{9}$')])),
                ('user_type', models.CharField(choices=[('ADMIN', 'Admin'), ('REGULAR', 'Regular User')], default='REGULAR', max_length=10)),
                ('groups', models.ManyToManyField(blank=True, related_name='marketplace_users', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='marketplace_users', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
                'verbose_name': 'user',
